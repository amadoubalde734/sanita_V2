...
from parametrage_general.models import Societe
# =========================================================
...
class License(models.Model):
    ...
    societe = models.ForeignKey(
        Societe, on_delete=models.PROTECT, related_name="licenses", verbose_name="Société",
    )
    ...
    # =====================================================
    # LIMITES
    # Ces valeurs sont automatiquement héritées du Plan
    # =====================================================
    max_users = models.PositiveIntegerField("Nombre maximum d'utilisateurs", default=10)
    max_sites = models.PositiveIntegerField("Nombre maximum de sites", default=1)
    ...
    def __str__(self):
        return f"{self.license_key} - {self.societe}"
    ...
    # =====================================================
    # APPLICATION DES LIMITES DU PLAN
    # =====================================================
    ...
    def update_status(self, save=True):
        ...
        # Une licence suspendue ou annulée
        # ne doit pas être réactivée automatiquement.
    ...
    def save(self, *args, **kwargs):
        ...
        # Application automatique du plan
...
class MaintenanceContract(models.Model):
    ...
    def __str__(self):
        return f"{self.contract_number} - {self.societe}"
    ...
    def generate_contract_number():
        ...
        while True:
            ...
            if not MaintenanceContract.objects.filter(
    ...
    def update_status(self, save=True):
        ...
        # Un contrat suspendu ou annulé
        # ne doit pas être réactivé automatiquement.
        if self.status in [
