...
from parametrage_general.models import Societe, Departement, Service, Fonction, Site, Ville, EmailSettings
...
def employe_list(request):
    ...
    return render(request, 'backend/pages/personnels/employe_list.html', {'employes': employes})
...
def employe_create(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('personnels:employe_list')
    else:
        form = EmployeForm()
    return render(request, 'backend/pages/personnels/ajouter_employer.html', {'form': form})
...
def employe_update(request, slug):
    ...
    return render(request, 'backend/pages/personnels/employe_update.html', {'form': form, 'employe': employe})
...
def employe_delete(request, slug):
    ...
    if request.method == 'POST':
        ...
        return redirect('personnels:employe_list')
    return render(request, 'backend/pages/personnels/employe_delete.html', {'employe': employe})
...
def employe_dashboard(request):
    ...
    return render(request, 'backend/pages/personnels/employe_dashboard.html', {
...
def employe_profil(request, slug):
    employe = get_object_or_404(Employe, slug=slug)
    return render(request, 'backend/pages/personnels/employe_profil.html', {'employe': employe})
...
def employe_historique(request, slug):
    ...
    return render(request, 'backend/pages/personnels/employe_historique.html', {'employe': employe, 'historique': historique})
