...
from .forms import ConfigurationEtablissementForm
...
@login_required
def index(request):
    return render(request, 'backend/pages/parametrage_general/index.html')
...
def ajouter_societe(request):
    ...
    return render(request, 'backend/pages/parametrage_general/liste_societes.html', {
        'societes': societes,
        'form': form,
        'modifier': False,
    })
...
def ajouter_ville(request):
    ...
    return render(request, 'backend/pages/parametrage_general/liste_villes.html', {
        'form': form,
        'villes': villes,
        'modifier': False,
    })
...
def ajouter_site(request):
    ...
    return render(request, 'backend/pages/parametrage_general/liste_sites.html', {
        'form': form,
        'sites': sites,
        'modifier': False,
    })
...
def ajouter_departement(request):
    ...
    return render(request, 'backend/pages/parametrage_general/liste_departements.html', {
        'form': form,
...
def ajouter_service(request):
    ...
    return render(request, 'backend/pages/parametrage_general/liste_services.html', {
        'form': form,
        'services': services,
        'departements': departements,
        'modifier': False,
...
def liste_fonctions(request):
    ...
    form = FonctionForm()
    return render(request, 'backend/pages/parametrage_general/liste_fonctions.html', {
        'fonctions': fonctions,
        'services': services,
        'form': form,
        'modifier': False,
...
def configuration_etablissement(request):
    ...
    return render(request, 'backend/pages/parametrage_general/config_etablissement/configuration_etablissement.html', {'config': config})
...
def modifier_configuration_etablissement(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            cache.delete('config_etablissement')  # <-- invalidation
            messages.success(request, "Configuration de l'établissement mise à jour.")
            return redirect('parametrage_general:configuration_etablissement')
    else:
        form = ConfigurationEtablissementForm(instance=config)
    return render(request, 'backend/pages/parametrage_general/config_etablissement/modifier_configuration_etablissement.html', {'form': form})